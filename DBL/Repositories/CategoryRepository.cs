        ...
        public IEnumerable<FirstCategory> GetAllFirstCategories()
        {
            using (var connection = new SQLiteConnection(_connString))
            {
                ...
                var categoryFirstQueryResult = connection.Query<FirstCategory>(
                    @"SELECT FirstCategoryId,FirstCategoryName,MainCategoryId,MainCategoryName FROM FirstCategory a INNER JOIN MainCategory b ON a.MainCategoryId = b.MainCategoryId");
        ...
        public IEnumerable<ThirdCategory> GetAllThirdCategories()
        {
            using (var connection = new SQLiteConnection(_connString))
            {
                ...
                var categoryThirdQueryResult = connection.Query<ThirdCategory>(
                    @"SELECT ThirdCategoryId,ThirdCategoryName,FirstCategoryId,FirstCategoryName FROM ThirdCategory a INNER JOIN FirstCategory b ON a.FirstCategoryId=b.FirstCategoryId");
